...
- [DNS overflow fallback](memory/dns-overflow-fallback.md) — DNS cache overflow kills curl AND aibtc MCP tools; only GitHub MCP survives; skip Phases 1–5, do Phase 6 only, output error
